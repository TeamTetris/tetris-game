...
export default class MenuScene extends Phaser.Scene {
	...
	private _createButtons(): void {
		...
		this._playButton = new TextButton(this, menuStartX, 0, "blue_button00.png", "blue_button01.png", "Start !", () => this._changeScene(config.sceneKeys.mainScene));
		this._optionsButton = new TextButton(this, menuStartX, 0, "blue_button00.png", "blue_button01.png", "Options", () => this._changeScene(config.sceneKeys.mainScene));
